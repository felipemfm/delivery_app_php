...
$searchInfo = getSearchResult($conn, $inquiry, $_SESSION["lat"], $_SESSION["long"]);
// print_r($searchInfo);
// exit;
?>
<!DOCTYPE html>
...
<title>検索結果 買物を依頼 | PON PON</title>
  ...
  <main class="main">
    ...
    <article class="wrap wrap--shopping">
      <div class="inner inner--tPd0">
        <h2 class="inner__title">検索結果： "<?php echo $inquiry ?>"</h2>
        <section class="store">
          <?php foreach ($searchInfo as $element) : ?>
