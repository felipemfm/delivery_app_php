...
$friendlist = array_splice($friendlist, 0, 8);
$userlist = getUserList($conn, $_SESSION["userid"], $_SESSION["lat"], $_SESSION["long"]);
$userlist = array_splice($userlist, 0, 20);
?>
<!DOCTYPE html>
<html>
<meta charset="utf-8">
    ...
    <article class="wrap wrap--friend">
      <div class="inner inner--tPd0">
        <div class="head head--flex">
          ...
          <a href="../delivery/friend-common.php" class="head__link">もっとみる</a>
        </div>
              ...
              <div class="cardBg__box">
                ...
                <ul class="cardBg__info">
                  ...
                  <li class="cardBg__button cardBg__button--request">
                    <form action="../delivery/friend-request.php" method="POST">
                      <button name="submit" name="submit">宅配を送る</button>
